...
var game = {
    ...
    thePath:{
      message:"You have left the fairy castle on a horse galloping down the path. You come to a fork in the path. Which path dou you take?",
     choices:[
         {
         ...
         ClearForest:{
         message:"You are attacked by a man eating plant.",
         choices:[{
             text:"The plant kills you",
             nextLevel:"startover",
         },]
    },
    move:{
    ...
    dragonDeath:{
    message:"Your screaming wakes the sleeping dragon and it attacks you burning your body You are dead.",
    choices:[{
    text:"Start Over",
    nextLevel:"startover",
    }]
